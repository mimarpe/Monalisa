...
public class MLSignalHandler implements SignalHandler {
     ...
     * Logging component
     */
    private static final transient Logger logger = Logger.getLogger("lia.util.MLSignalHandler");
    ...
    public synchronized static final MLSignalHandler getInstance() {
        if(!installMLSignalHandler) return null;
        ...
        try {
            ...
            if (s.getName().equals("HUP")) {
                ...
                if(diffHUPTime <= SIGNALS_DELTA ) {
                    ...
                    final String msg = "ML_SER stop request @ SysDate: " + new Date(cTime) + " | NtpDate: " + new Date(nTime);
                    ...
                    synchronized(syncLock) {
                        ...
                        if(lastWarningLogger + NOTIFY_DELTA < now) {
                            ...
                            logger.log(Level.WARNING, " SIGTERM received without SIGHUP and SIGINT first ... ", new Object[]{mlle});
                        }
                    }
                }
            }
