...
public class UpdaterArgs {
     ...
     * 
     * @param args
     * @throws IllegalArgumentException if the following params are not set: appname, jnlps, cachedir, destdir
     */
    ...
    public String toString() {
        ...
        builder.append("UpdaterArgs [jnlps=").append(jnlps).append(", appname=").append(appname).append(", appversion=").append(appversion).append(", cacheDirPath=").append(cacheDirPath).append(", destDirPath=").append(destDirPath).append(", noupdatelog=").append(noupdatelog).append("]");
