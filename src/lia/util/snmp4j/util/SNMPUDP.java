...
public class SNMPUDP {
	...
	public SNMPUDP(String defaultOptions, SNMPFactory snmp, String snmpAddress, String farmName, String clusterName, String moduleName){
		this.snmp = snmp;
	...
	public void setFlags(boolean udpInDatagramsFlag, boolean udpNoPortsFlag, boolean udpInErrorsFlag, boolean udpOutDatagramsFlag) {
