...
public class AuthZJiniService extends Thread implements ServiceIDListener, ServiceDiscoveryListener, DiscoveryListener {
	...
	/** Logger name */
	private static final transient String COMPONENT = "lia.util.security.authz.jini";
	...
	private String getCodebase() {
		String codebase = "";
		String dlURLs = AppConfig.getProperty(
												"lia.util.security.authz.dlURLs",
	...
	public static void main(String args[]) {
		...
		boolean useSecLUSs = Boolean.valueOf(AppConfig.getProperty("lia.util.topology.useSecureLUSs", "false")).booleanValue();
		if (useSecLUSs) {
			...
			try {
				 ...
				 */
				String privateKeyPath = AppConfig.getProperty("lia.util.topology.privateKeyFile", "/etc/grid-security/hostkey.pem");
				String certChainPath = AppConfig.getProperty("lia.util.topology.certChainFile", "/etc/grid-security/hostcert.pem");
