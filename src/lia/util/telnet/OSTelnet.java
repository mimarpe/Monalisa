...
public abstract class OSTelnet extends TL1Telnet {
    ...
    private static final transient Logger logger = Logger.getLogger(OSTelnet.class.getName());
	...
	public abstract boolean changeRSVP(String msgRetryInvl, String ntfRetryInvl, String grInvl, String grcInvl) throws Exception;
	public abstract boolean addCtrlCh(String name, String remoteIP, String remoteRid, String port, String adj, String helloInvl, String helloInvlMin, 
			String helloInvlMax, String deadInvl, String deadInvlMin, String deadInvlMax) throws Exception;
	public abstract boolean delCtrlCh(String name) throws Exception;
	public abstract boolean changeCtrlCh(String name, String remoteIP, String remoteRid, String port, String adj, String helloInvl, String helloInvlMin, 
			String helloInvlMax, String deadInvl, String deadInvlMin, String deadInvlMax) throws Exception;
	public abstract boolean addAdj(String name, String ctrlCh, String remoteRid, String ospfArea, String metric, String ospfAdj, String adjType, String rsvpRRFlag, 
			String rsvpGRFlag, String ntfProc) throws Exception; 
	public abstract boolean deleteAdj(String name) throws Exception; 
	public abstract boolean changeAdj(String name, String ctrlCh, String remoteRid, String ospfArea, String metric, String ospfAdj, String adjType, String rsvpRRFlag, 
			String rsvpGRFlag, String ntfProc) throws Exception; 
	...
	public abstract boolean changeLink(String name, String localIP, String remoteIP, String linkType, String adj, String wdmAdj, 
    ...
    public static final short getType(String type) {
        if(type == null || type.length() == 0) return NOSUCHTYPE;
        if(type.toLowerCase().equals("glimmerglass")) return GLIMMERGLASS;
        if(type.toLowerCase().equals("calient")) return CALIENT;
        return NOSUCHTYPE;
    }
