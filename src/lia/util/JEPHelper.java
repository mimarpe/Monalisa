...
public final class JEPHelper {
	...
	private static final Logger	logger				= Logger.getLogger("lia.util.JEPHelper");
	...
	public static String evaluateExpression(final String sExpr){
        ...
        if (o==null || (o instanceof Double && Double.isNaN(((Double)o).doubleValue())) || jep.getErrorInfo()!=null){
        	if (logger.isLoggable(Level.FINE)){
        		try{
        			throw new Exception(sExpr);
        		}
        		catch (Exception e){
        			logger.log(Level.FINE, "Error evaluating '"+sExpr+"' : "+jep.getErrorInfo()+" "+Thread.currentThread().getName(), e);
        		}
        	}
        	else{
        		logger.log(Level.INFO, "Error evaluating '' : "+jep.getErrorInfo()+" (put lia.util.JEPHelper.level=FINE for more details)");
        	}
	...
	private static final class StripHTML extends org.nfunk.jep.function.PostfixMathCommand {
		...
		public void run(@SuppressWarnings("rawtypes") final Stack inStack) throws org.nfunk.jep.ParseException {
            ...
            if (param instanceof String) {
                ...
                throw new org.nfunk.jep.ParseException("Invalid parameter type. Expected String but got "+param.getClass().getName());
            }
        }
    ...
    private static final class IndexOf extends org.nfunk.jep.function.PostfixMathCommand {
		...
		public void run(@SuppressWarnings("rawtypes") final Stack inStack) throws org.nfunk.jep.ParseException {
            ...
            if (o1==null || o2==null || !(o1 instanceof String) || !(o2 instanceof String)){
            	throw new org.nfunk.jep.ParseException("First parameter of datetime() must be the date formatting string");
            }
