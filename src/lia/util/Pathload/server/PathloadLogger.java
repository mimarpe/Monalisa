...
public class PathloadLogger implements XMLWritable {	
	 ...
	 * Logging component
	 */
	private static final transient Logger logger = Logger.getLogger("lia.util.Pathload.server.PathloadLogger");	
	...
	public void log(Level logLevel, String message) {
		...
		if (logLevel.intValue() < PathloadLogger.PRIORITY_LEVEL) return;
