...
public class CienaVCGTrigger implements Filter, Observer {
    ...
    private static final transient Logger logger = Logger.getLogger(CienaVCGTrigger.class.getName());
    ...
    public CienaVCGTrigger() throws Exception {
        ...
        if(confFileName == null) {
            throw new InstantiationException("The config file for CienaVCGTrigger is not defined. Check that the property: " + propName + " is defined");
        }
    ...
    private void reloadConfig() throws Exception {
        ...
        for(final String sectionName: sectionNames) {
            if(sectionName.equals(DEFAULT_SETTINGS_SECTION_NAME)) continue;
    ...
    private static final double getDouble(final IniEditor iniConfig, final String sectionName, final String property, double defaultVal) {
        ...
        try {
            ...
            logger.log(Level.WARNING, "Exception parsing double val for sectionName: " + sectionName +
                       "; propertyName: " + property +"; propVal: " + doubleProp + ". Will return default val: " + defaultVal, t);
            retV = defaultVal;
        }
    ...
    private static final monPredicate getPredicate(final IniEditor iniConfig, final String sectionName, final String property) {
