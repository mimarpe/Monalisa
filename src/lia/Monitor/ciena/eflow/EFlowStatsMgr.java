...
public final class EFlowStatsMgr {
    private static final transient Logger logger = Logger.getLogger(EFlowStatsMgr.class.getName());
        ...
        public void run() {
			...
			for(final EFlowStatsConsumer c: consumers) {
				try {
					...
					logger.log(Level.WARNING, "[EFlowStatsMgr] Exception notifying: " + stats + " to: " + c +" Cause: ", t);
				}
			}
		}
	}
