...
//                newOSI.map.put(pi, new OpticalLink(pi, null, null, Double.valueOf(OpticalLink.MIN_QUAL), new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.DISCONNECTED)));
                newOSI.map.put(pi, new OpticalLink(pi, null, null, Double.valueOf(OpticalLink.MIN_QUAL), new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
...
//                newOSI.map.put(po, new OpticalLink(po, null, null, Double.valueOf(OpticalLink.MIN_QUAL), new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.DISCONNECTED)));
                newOSI.map.put(po, new OpticalLink(po, null, null, Double.valueOf(OpticalLink.MIN_QUAL), new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
...
//                newOSI.map.put(po, new OpticalLink(po, null, null, Double.valueOf(OpticalLink.MIN_QUAL), new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.DISCONNECTED)));
        ...
        if(typeS.equalsIgnoreCase("host")) {
            OSPort pi = new OSPort(portNameS, OSPort.INPUT_PORT);
            OSPort po = new OSPort(portNameS, OSPort.OUTPUT_PORT);
            newOSI.map.put(pi, new OpticalLink(pi, hostname, dPortNameS, quality, new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
            newOSI.map.put(po, new OpticalLink(po, hostname, dPortNameS, quality, new Short(OpticalLink.TYPE_HOST), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
        } else if (typeS.equalsIgnoreCase("switch")) {
            OSPort pi = new OSPort(portNameS, OSPort.INPUT_PORT);
            OSPort po = new OSPort(portNameS, OSPort.OUTPUT_PORT);
            newOSI.map.put(pi, new OpticalLink(pi, hostname, dPortNameS, quality, new Short(OpticalLink.TYPE_SWITCH), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
            newOSI.map.put(po, new OpticalLink(po, hostname, dPortNameS, quality, new Short(OpticalLink.TYPE_SWITCH), Integer.valueOf(OpticalLink.CONNECTED | OpticalLink.FREE)));
