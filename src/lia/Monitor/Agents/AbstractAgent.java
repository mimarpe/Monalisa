...
public abstract class AbstractAgent implements AgentI, MonitorFilter {
    ...
    private static final transient Logger logger = Logger.getLogger(AbstractAgent.class.getName());
    ...
    private AgentMessage createIntMsg(
            int messageID,
            int messageType,
            int messageTypeAck,
            int priority,
	...
	public AgentMessage createMsg(
			...
			String agentGroupD,
			Object message) {
	    return createIntMsg(messageID, messageType, messageTypeAck, 
                priority, agentAddrD, agentGroupD, message, true );
		} // basicMsg
	
    public AgentMessage createCtrlMsg(
            int messageID,
            int messageType,
            int messageTypeAck,
            int priority,
            ...
            Object message) {
        return createIntMsg(messageID, messageType, messageTypeAck, 
                priority, agentAddrD, agentGroupD, message, false );
    }
