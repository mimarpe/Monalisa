...
public class GmapPan extends JPanel implements graphical, ActionListener, ChangeListener {
	...
	/** Logger name */
	private static final transient String COMPONENT = "lia.Monitor.JiniClient.VRVS3D.Gmap";
...
//		ckUsers.setPreferredSize(ckSlider);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(cmd.equals("Elastic") || cmd.equals("Random") || cmd.equals("Grid") 
		        || cmd.equals("Layered") || cmd.equals("Radial")) {
		    ...
		    grapPan.repaint();
		    return;
		}else if(src.equals( optPan.kbShowMST) || src.equals(optPan.kbShowPeers)
				|| src.equals(optPan.kbShowPing) || src.equals( optPan.cbNodeOpts)
				|| src.equals(optPan.cbPeerOpts)){
