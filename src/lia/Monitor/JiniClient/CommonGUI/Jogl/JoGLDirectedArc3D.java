...
public class JoGLDirectedArc3D extends JoGLArc3D 
{
	...
	public JoGLDirectedArc3D( double fromLAT, double fromLONG, double toLAT, double toLONG, double radius, float degreeIncrement, double bowPar, float zTranslation, double bowPer) 
	{
	...
	public void drawArc( GL gl)
	{
		...
		if ( bPlaneProjection ) {
			...
			for( int i=0; i<=nrPoints; i++) {
				...
				if ( points!=null ) points.add( new VectorO(vPoint));
