...
public class NodeToolTipText {
	...
	protected static Logger logger = Logger.getLogger("lia.Monitor.JiniClient.CommonGUI.NodeToolTipText");
	...
	protected static boolean isValid(String val){
		...
		if(val.indexOf("N/A") >= 0) return false;
	...
	public static String getToolTip(rcNode node){
		...
		if(node.mlentry != null && isValid(node.mlentry.Location)) text += node.mlentry.Location;
