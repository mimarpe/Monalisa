...
public class MultipleMonData3DPlotClus
	implements
		LocalDataFarmClient,
		MultipleDataPlotter,
		ActionListener,
	...
	public MultipleMonData3DPlotClus(
		DataPlotterParent parent,
		rcNode[] selectedNodes,
		Vector predicates,
		Vector clusters) {
	...
	private void formStringResultFrame() {
		...
		JOptionPane.showMessageDialog(p, "There is string data available also... please see View->Show string results menu item.");
	}
