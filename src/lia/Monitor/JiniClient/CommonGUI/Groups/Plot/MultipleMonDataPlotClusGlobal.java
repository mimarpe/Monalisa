...
public class MultipleMonDataPlotClusGlobal
	implements
		LocalDataFarmClient,
		MultipleDataPlotter,
		ActionListener,
	...
	public MultipleMonDataPlotClusGlobal(
		DataPlotterParent parent,
		rcNode[] selectedNodes,
		Vector predicates,
		Vector clusters) {
	...
	public void setCurrentUnit(HashMap unit) {
		if (unit != null && unit.size() != 0 && p != null) {
			baseUnit = (Unit)unit.get(unit.keySet().iterator().next());
	...
	public void setFarmName(String farmName) {
		p.chartFrame.setTitle(farmName);
	}
