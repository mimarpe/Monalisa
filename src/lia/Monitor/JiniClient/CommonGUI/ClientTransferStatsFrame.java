...
public class ClientTransferStatsFrame extends JFrame implements ActionListener, WindowListener
{
	...
	/** Logger name */
	private static final transient String COMPONENT = "lia.Monitor.JiniClient.CommonGUI.ClientTransferStats";
...
//		jlbAll.setPreferredSize(new Dimension(900, 130));
		...
		graph = new MultiGraphPanel(
				"Statistics for traffic between client and proxy",
				texts,
				colors,
				max_texts, 
				max_colors,
