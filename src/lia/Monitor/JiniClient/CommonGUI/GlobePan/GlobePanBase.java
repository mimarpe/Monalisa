...
public class GlobePanBase extends JPanel
                      implements ActionListener,
                                 ChangeListener,
                                 NodeSelectionListener,
								 LinkHighlightedListener,
                                 graphical
{
	/** Logger name */
	private static final transient String COMPONENT = "lia.Monitor.JiniClient.CommonGUI.GlobePanBase";
...
//	int peersMode;
  ...
  public GlobePanBase() {
  	...
  	NO_BOUNDS = new BoundingBox(new Point3d(Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY),
  ...
  void buildEarth(){
	...
	int imageSlices = Integer.valueOf(AppConfig.getProperty("lia.Monitor.globeTexture.slices","0")).intValue();
	if(imageSlices < 2){
		// single slice
