...
public class Traff extends JPanel implements graphical, ComponentListener {
	/** Logger name */
	private static final transient String COMPONENT = "lia.Monitor.JiniClient.Farms.Histograms";
	...
	public Traff(){
		barChart = new BarChartPanel("WAN Traffic",
				"WAN Links", "Mb/s", labels, min, max, count, false);
