...
public class OpticalSwitchMonitorControl implements PortAdminListener, LocalDataFarmClient {
    ...
    private static final transient Logger logger = Logger.getLogger("lia.Monitor.JiniClient.Farms.OpticalSwitch.Config.OSMonitorControl");
	...
	private Vector alreadyAddedPorts;
	...
	private OpticalSwitchMonitorControl(LocalDataFarmProvider provider, String address, int remoteRegistryPort) throws Exception {
	...
	public static OpticalSwitchMonitorControl connectTo(LocalDataFarmProvider provider, String address, int remoteRegistryPort) {
