...
public class ConfigFrame extends JFrame implements ActionListener, ItemListener, WindowListener, MouseListener, ComponentListener {
	...
	private static final transient Logger logger = Logger.getLogger("lia.Monitor.JiniClient.Farms.OpticalSwitch.Config");
...
//		getContentPane().add(scrollP);
	...
	public void windowClosing(WindowEvent e) {
		...
		if (control == null || control.provider == null || ((tClient)control.provider).trcframe == null ||
			...
			return;
		OpticalSwitchPan panel = (OpticalSwitchPan)((tClient)control.provider).trcframe.serMonitorBase.main.getGraphical("OpticalSwitchMap");
