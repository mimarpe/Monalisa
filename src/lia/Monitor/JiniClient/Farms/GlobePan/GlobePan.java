...
public class GlobePan extends GlobePanBase {
	...
	/** Logger name */
	private static final transient String COMPONENT = "lia.Monitor.JiniClient.Farms.GlobePan";
	...
	private Object syncRefreshNodes = new Object();
	...
	public void refresh() {
		...
		try{
			...
			synchronized(syncRefreshNodes){
				...
				for(Enumeration en = vnodes.elements(); en.hasMoreElements(); ) {
