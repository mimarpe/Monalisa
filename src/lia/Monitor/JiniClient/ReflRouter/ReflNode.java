...
public class ReflNode {
    /** Logger name */
    private static final transient String COMPONENT = "lia.Monitor.JiniClient.ReflRouter.ReflNode";
	...
	public void processInetResult(ReflNode dstNode, Result r){
		...
		if(tun == null){
            ...
            if(logger.isLoggable(Level.FINER)) {
                logger.log(Level.FINER, "adding tunnel for inet info: "+UnitName+" -> "+dstNode.UnitName+" for: "+r);
            }
		}
	...
	public String toString(){
		...
		sb.append(" for "); appendDelay(sb, NTPDate.currentTimeMillis() - statusChangeTime);
		sb.append(" penalized=").append(isPenalized());
		sb.append(" last result "); appendDelay(sb, NTPDate.currentTimeMillis() - lastResultTime);
