...
public class Netstat extends AbstractSchJobMonitoring {
	 ...
	 * Message logger
	 */
	static final transient Logger logger = Logger.getLogger(Netstat.class.getName());
	...
	public Object doProcess() throws Exception {
		...
		final String output = ExternalProcesses.getCmdOutput(Arrays.asList("netstat", "-a", "-n"), false, 60, TimeUnit.SECONDS);
		...
		final Map<String, AtomicInteger> states = new HashMap<String, AtomicInteger>();
		...
		while ( (sLine = br.readLine()) != null ){
			...
			if (isSolarisOS()){
				...
				if (bTCP4 || bTCP6){
					String base = bTCP4 ? "sockets_tcp" : "sockets_tcp6";
