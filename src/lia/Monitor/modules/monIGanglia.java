...
static String[] metric={"cpu_num", "cpu_user","cpu_system","cpu_nice", "bytes_in","bytes_out","load_five","load_one", "load_fifteen", "proc_run", "mem_free", "mem_shared", "mem_cached", "mem_buffers", "mem_total", "disk_free", "disk_total" }; 
...
static String[] tmetric={"NoCPUs", "CPU_usr", "CPU_sys","CPU_nice", "TotalIO_Rate_IN", "TotalIO_Rate_OUT", "Load5","Load1","Load15", "proc_run", "MEM_free", "MEM_shared", "MEM_cached", "MEM_buffers", "MEM_total", "DISK_free", "DISK_total"}; 
