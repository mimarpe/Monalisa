/*
 * $Id: monOSCrossConns_v2.java 6865 2010-10-10 10:03:16Z ramiro $
 */
...
public class monOSCrossConns_v2 extends cmdExec implements MonitoringModule, Observer {
	...
	private static final transient Logger logger = Logger.getLogger(monOSCrossConns_v2.class.getName());
...
//        portsSendCounter = 0;
                ...
                if (argT.startsWith("SwitchType")){
                    ...
                    try {
                        ...
                        if(f.exists() && f.canRead()) {
                            ...
                            logger.log(Level.WARNING, "[ monOSCrossConns_v2 ] File for PortMap = " + f.toString() + " cannot be read!");
                        }
                    } catch(Throwable t) {
                        logger.log(Level.WARNING, " [ monOSCrossConns_v2 ] Got exc trying to init DateFileWatchdog for configuration file", t);
                        dfw = null;
                        moduleConfFile = null;
                    }
    ...
    private void reloadConf() {
        ...
        try {
            ...
            logger.log(Level.WARNING, "[ monOSCrossConns_v2 ]Got exception (re)loading configuration from the conf file [ " + moduleConfFile +" ]", t);
        }
        ...
        try {
            ...
            for(int linIt=0; linIt<lines.length; linIt++) {
                ...
                if(len1 > 0) {
                    ...
                    if (tmpSplit.length != 12) continue;
        ...
        try {
            ...
            for(int linIt=0; linIt<lines.length; linIt++) {
                ...
                if(len1 > 0) {
                    ...
                    String[] tmpSplit = secondSplitS[1].split(",");
                    if (tmpSplit.length != 11) continue;
