/*
 * $Id: ServiceLoggerConn.java 7273 2012-06-26 15:47:08Z ramiro $
 */
...
public class ServiceLoggerConn extends Thread implements tcpConnNotifier {
    ...
    private static final transient Logger logger = Logger.getLogger(ServiceLoggerConn.class.getName());
    ...
    private boolean connect() {
        try {
            if(si == null || si.service == null || si.attributeSets == null) {
                logger.log(Level.WARNING, " [ ServiceLoggerConn ] Eiteher ServiceItem, or si.service or si.attributesSets is null");
                return false;
            }
            ...
            if(si.service instanceof MLLoggerSI) {
                ...
                try {
                    ...
                    logger.log(Level.WARNING, " [ ServiceLoggerConn ] Got exception trying to determine port from GMLE.", t);
                    port = -1;
                }
            ...
            logger.log(Level.WARNING, " [ ServiceLoggerConn ] got a ServiceItem which is not instanceof MLLoggerSI" + si.service.getClass());
        }catch(Throwable t) {
