/*
 * $Id: ServiceLoggerManager.java 7112 2011-03-05 12:36:26Z ramiro $
 */
...
public class ServiceLoggerManager extends Thread {
    ...
    private static final transient Logger logger = Logger.getLogger(ServiceLoggerManager.class.getName());

    private static final ServiceLoggerManager _thisInstance;

    private static final ConcurrentSkipListMap<ServiceID, ServiceLoggerConn> loggerConns = new ConcurrentSkipListMap<ServiceID, ServiceLoggerConn>(ServiceIDComparator.getInstance());
                ...
                try {
                    ...
                    if(loggers != null && loggers.length != 0) {
                        for(final ServiceItem si: loggers) {
                            if(loggerConns.containsKey(si.serviceID)) continue;
