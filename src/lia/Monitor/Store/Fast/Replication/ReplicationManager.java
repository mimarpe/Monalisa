...
public final class ReplicationManager {
	 ...
	 * logger
	 */
	private static final Logger	logger = Logger.getLogger("lia.Monitor.Store.Fast.Replication.ReplicationManager");
	...
	public DBConnectionWrapper query(final String sQuery, final boolean ignoreErrors, final boolean broadcastAlways){
		return query(sQuery, ignoreErrors, broadcastAlways, null);
	}
	 ...
	 * @return the connection wrapper, or <code>null</code> if the query could not be executed on any of the backends
	 */
	public DBConnectionWrapper query(final String sQuery, final boolean ignoreErrors, final boolean broadcastAlways, final DBConnectionWrapper previous){
