...
final class TempMemWriter3Index implements Comparable<TempMemWriter3Index> {
     ...
     * All values
     */
    final PriorityQueue<Object> llData;
     ...
     * @param ll
     */
    public TempMemWriter3Index(final long l, final PriorityQueue<Object> ll) {
        time = l;
        llData = ll;
    ...
    public final boolean equals(final Object o) {
        if (o != null) {
            ...
            if (seq == ((TempMemWriter3Index) o).seq) {
                ...
                logger.log(Level.SEVERE, " [ TempMemWriter3Index ] Same seq ... different Objects. seq: " + seq + " otherSeq: " + ((TempMemWriter3Index) o).seq);
            }
        }
        return false;
    }
