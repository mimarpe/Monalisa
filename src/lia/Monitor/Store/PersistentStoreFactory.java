...
public class PersistentStoreFactory {
    /** Logger Name */
    private static final transient String COMPONENT = "lia.Monitor.Store";
    /** The Logger */ 
     ...
     * @throws StoreException
     */
    public static AbstractPersistentStore getPersistentStore(String storeClassName, String[] URLs) throws StoreException{
     ...
     * @throws StoreException
     */
    public static AbstractPersistentStore getPersistentStore(final String storeClassName, final URL[] URLList) throws StoreException{
        if( _loader == null ) {
            try{
                  if ( URLList != null )  
        ...
        if (_persistentStore == null){
				...
				if (_persistentStore != null) return _persistentStore;            
                    if ( storeClassName != null &&
                         ( storeClassName.equals("lia.Monitor.Store.Sql.Web.MysqlStore") ||
                          storeClassName.equals("lia.Monitor.Store.Sql.MysqlStore") )
                     ){
                         try {
...
//						   _persistentStore = (AbstractPersistentStore) new EMcKoiStore();
    ...
    private static URL[] getURLs(String[] strURLs) {
        if (strURLs == null || strURLs.length == 0 ) return null;
