...
public class FDTFilter extends GenericMLFilter {
    ...
    private static final transient Logger logger = Logger.getLogger("lia.Monitor.Filters.FDTFilter");
    ...
    private Hashtable htLinksWithTransfers; 	// key=linkName(w/o dir), value=hash: key=transfName; value=FDTTransfer
