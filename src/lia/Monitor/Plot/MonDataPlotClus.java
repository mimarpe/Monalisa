...
public class MonDataPlotClus implements LocalDataFarmClient, DataPlotter, ActionListener, ComponentListener, WindowListener, TimeSliderAdjustmentListener {
    ...
    public MonDataPlotClus(DataPlotterParent parent, LocalDataFarmProvider dataprovider, Vector predicates, Vector clusters) {
