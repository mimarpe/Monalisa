...
public class TransferUtils {
	...
	public final static Logger logger = Logger.getLogger(TransferUtils.class.getName());
	...
	public static long parseBKMGps(String value){
		...
		switch(suffix){
		case 'T':	mul = 1000 * 1000 * 1000 * 1000; break;
		case 'G':	mul = 1000 * 1000 * 1000; break;
		case 'M':	mul = 1000 * 1000; break;
		case 'K':	mul = 1000; break;
		case 'B':	mul = 1; break;
		default :	val = value; // take the full string, including the suffix
		}
		try{
	...
	public static String joinProperties(Properties prop, char equalSign, char moreChar){
		...
		for(Iterator meit = prop.entrySet().iterator(); meit.hasNext(); ){
	...
	public static Properties splitString(String propString, String separator){
		...
		while(stk.hasMoreTokens()) {
			...
			if(line.length() == 0 || line.startsWith("#"))	// ignore empty and comment lines
				continue;
