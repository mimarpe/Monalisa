...
public class ABPing {
    ...
    /** Logger name */
    private static final String COMPONENT = "lia.Monitor.Farm.ABPing";
				...
				while(active) {
					...
					for(Enumeration en = myPeers.keys(); en.hasMoreElements(); ){
						...
						if(pi != null) {
							...
							if(rtt < 0) rtt = 0;							
							myPi.jitter = JITTER_COEF * Math.abs(rtt - myPi.rtt) +
											(1 - JITTER_COEF) * myPi.jitter;
							myPi.rtt = rtt;
