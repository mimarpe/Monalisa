...
public final class AsyncPredManager {
	 ...
	 */
	static final Logger	logger	= Logger.getLogger(AsyncPredManager.class.getName());
	 ...
	 */
	public static Vector<Object> getValues(final monPredicate pred, final long lLastQueryTime){
		verifyPred(pred);
		...
		final Vector<Object> v = store.select(pred);
