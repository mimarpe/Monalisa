...
public class genimage extends ThreadedPage {
	...
	*/
	...
	Vector<WNode> vNodes = new Vector<WNode>();
	HashMap<String, WNode> hmNodes = new HashMap<String, WNode>();
	...
	for (int i=0; i<vData.size(); i++){
		...
		if (o!=null && (o instanceof Result)){
		    wn.alternate = new LinkedList<Object>();
		    wn.alternate.add(o);
		}
	    }
	...
	*/
	...
	Vector<WLink> vLinks = new Vector<WLink>();
	...
	for (int i=0; i<vData.size(); i++){
	    ...
	    Hashtable<String, Double> htData = new Hashtable<String, Double>();
	...
	*/
	...
	Vector<Object> vSpecial = new Vector<Object>();
	...
	*/
	...
	try{
	    ...
	    if (bJPEG) ChartUtilities.writeBufferedImageAsJPEG(out, (float) fJPEGcompression, image);
	    else       ChartUtilities.writeBufferedImageAsPNG(out, image);
