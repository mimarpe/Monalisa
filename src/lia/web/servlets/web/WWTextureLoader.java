...
public final class WWTextureLoader {
	private static Logger		logger		= Logger.getLogger("lia.web.servlets.web");

	private static Hashtable<String, BufferedImage>	textures	= new Hashtable<String, BufferedImage>();
