...
public class simple extends CacheServlet {
	...
	public void execGet() {
		...
		boolean bSmall = (height < 200 || width < 200) ||
		         (dMax >= 1000 && (height < 400 || width < 400));
		...
		Utils.logRequest("simple", (int)(System.currentTimeMillis()-lStart), request, false);
	}
	 ...
	 * 
	 * @param prop configuration options
	 * @param values value array, the first position counts
	 * @param bSmall small font
	 * @return the chart
	 */
	public static Plot getDial2Chart(Properties prop, Vector<Double> values, boolean bSmall) {
        ...
        GradientPaint gp = new GradientPaint(new Point(),
                ColorFactory.getColor(255, 255, 255), new Point(),
                ColorFactory.getColor(240, 240, 240));
	 ...
	 * @param values values to display (should be at least two in this vector)
	 * @param bSmall small font
	 * @return the chart
	 */
	public static Plot getDialThermo2Chart(Properties prop, Vector<Double> values, boolean bSmall) {
        ...
        GradientPaint gp = new GradientPaint(new Point(),
                ColorFactory.getColor(255, 255, 255), new Point(),
                ColorFactory.getColor(170, 170, 220));
	 ...
	 * @param values values to display. the first entry is displayed
	 * @param bSmall small font
	 ...
	 * 
	 * @param prop configuration options
	 * @param values values to display (only the first one is taken)
	 * @return the chart
	 */
