...
public class SearchDaemonConfig implements Observer {
    ...
    private static final transient Logger logger = Logger.getLogger("lia.searchdaemon.SearchDaemonConfig");
    ...
    public final synchronized String getProperty(String key, String defaultValue) {
        ...
        if ( retS != null ) return retS.trim();
        
        if(cProps == null) return defaultValue;
